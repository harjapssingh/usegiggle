  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pin-pop": { "0%": { transform: "scale(0.85)", opacity: "0" }, "60%": { transform: "scale(1.05)", opacity: "1" }, "100%": { transform: "scale(1)", opacity: "1" } },
      ...
      animation: {
        ...
        "pin-pop": "pin-pop 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) both",
      },
    },
  },
